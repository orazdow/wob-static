...
// global Perlin
// val  Perlin.noise(x, y = 0, z = 0)
// void Perlin.noiseDetail(lod, falloff)
// void Perlin.noiseSeed(seed)
...
// ((global)=>{
	...
	m.noiseDetail = function(lod, falloff) {
	  if (lod > 0) {
	    perlin_octaves = lod;
	  }
	  if (falloff > 0) {
